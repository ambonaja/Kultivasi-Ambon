--==================================================
-- AUTO FARM FISH | FINAL + FALLBACK POSISI PLAYER
-- Delay 2.5s | Weight 600-700
-- FishGivers1 | Mobile & PC SAFE
--==================================================
...
--==================================================
-- FALLBACK POSITION (INI KUNCI OPSI 2)
--==================================================
...
toggle.Position = UDim2.fromOffset(40,30)
...
countdown.Position = UDim2.fromOffset(40,80)
...
task.spawn(function()
	while true do
		if autofarm then
			...
			local hookPos = fish and getHookPos(fish)

			if fish and hookPos then
				pcall(function()
