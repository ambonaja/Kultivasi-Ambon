--// MT YAYAKIN SUMMIT 100
--// AUTO LOOP RUN ALL CP → SUMMIT → BC (FINAL)
...
local Points = {
    CP = {
        {"CP1", Vector3.new(-424,249,734)},
        {"CP2", Vector3.new(-348,387,531)},
        {"CP3", Vector3.new(274,429,501)},
        {"CP4", Vector3.new(330,489,350)},
        {"CP5", Vector3.new(222,313,-148)},
    },
    Summit = Vector3.new(-616,905,-552),
    BC = Vector3.new(-947,169,857)
}
...
header.Text = "MT YAYAKIN SUMMIT 100"
